      ...
      <div className="containerInfo">
        ...
        <div className="properties">
          <ul className="list-group list-group-flush">
            ...
            <li className="list-group-item">Orbital Period: {infoPlanet == "" ? "Loading..." : infoPlanet.result.properties.orbital_period}</li>
            <li className="list-group-item">Gravity: {infoPlanet == "" ? "Loading..." : infoPlanet.result.properties.gravity}</li>
            <li className="list-group-item">Climate: {infoPlanet == "" ? "Loading..." : infoPlanet.result.properties.climate}</li>
            <li className="list-group-item">Terrain: {infoPlanet == "" ? "Loading..." : infoPlanet.result.properties.terrain}</li>
          </ul>
        </div>
      </div>
    </>
